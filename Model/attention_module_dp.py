...
WHY gradient checkpointing must be disabled for DP-SGD:
    ...
    bypasses Opacus's forward hooks → the recorded activations are stale/wrong
    → per-sample gradients are computed incorrectly → privacy guarantee broken.
...
from util_network import default, exists, normalization, zero_module, checkpoint
    ...
    def __init__(self, in_channels, n_heads, d_head,
        ...
        self.transformer_blocks = nn.ModuleList([
            BasicTransformerBlock(
                ...
                checkpoint=False,                          # ← explicit False
            )
