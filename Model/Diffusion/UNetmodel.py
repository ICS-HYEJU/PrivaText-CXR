...
from Model.util_network import (                              # noqa: E402
    conv_nd, linear, normalization,
    zero_module, checkpoint, timestep_embedding,
)
from Model.UNetBlock_module import ResBlock, Upsample, Downsample    # noqa: E402
from Model.timestep_block import TimestepBlock, TimestepEmbedSequential  # noqa: E402
from Model.attention_module import SpatialTransformer         # noqa: E402
...
if __name__ == '__main__':
    ...
    ctx = torch.randn(B, 1, args.context_dim, device=device)   # [B, seq, context_dim]
