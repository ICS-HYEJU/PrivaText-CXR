...
#
#     # Paths
#     parser.add_argument("--root_path",  type=str, default='/home/hjchoi/physionet.org/files/mimic-cxr/2.1.0/')
...
#         <split_dir>/
#         |-- train/    |--p10/   |--p10000032/   |--s50414267/  |-- <id>.d237972cm
#         |-- validate/
#         |-- test/
#
#     Args:
...
def parse_args():
    ...
    # prepare_split_dirs
    parser.add_argument("--make_split_dir", default=True, action="store_true",
                        help="organise files into train/validate/test folders "
                             "(run once after data download completes; safe to re-run)")
    parser.add_argument("--split_dir",   type=str, default='/storage/hjchoi/mimic/split',
                        help="output root for split folders "
                             "(default: <root_path>/split)")
    parser.add_argument("--use_symlink", action="store_true", default=True,
                        help="use symlinks instead of file copies in split dirs")
